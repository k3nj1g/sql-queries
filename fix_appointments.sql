...
SELECT jsonb_set('{}'::jsonb, '{actor}', jsonb_build_object('id', 'e46ebe68-6fba-4345-828e-248765e2d5d5', 'display', 'Кабинет вакцинации от COVID-19 №106', 'resourceType', 'Location'))